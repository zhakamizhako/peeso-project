...
class Book extends Component {
    ...
    onConfirm() {
        Modal.alert("Information", "The City Public Education and Employment Service office will contact you toconfirm your booking reservation and for more addtional details. Thank you.", [{ text: "Okay!", onPress: () => this.props.navigation.navigate('homepage') }])
    }

    renderBook(data, index) {
        return (<List>
            <List.Item multipleLine={false}>Name of Freelancer: {data.firstname + " " + data.lastname}</List.Item>
            <DatePicker><List.Item>Date and Time</List.Item></DatePicker>
