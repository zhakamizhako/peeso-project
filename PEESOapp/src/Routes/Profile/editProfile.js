...
class EditProfileApplicant extends Component {
    constructor(props) {
        super(props);
        this.state = {
            firstname: null,
    ...
    componentWillReceiveProps(props) {
        ...
        console.log('EditProfileApplicant props');
        console.log(props);
        console.log('------------');
...
export default connect(mapStateToProps, mapActionCreators)(EditProfileApplicant);

EditProfileApplicant.propTypes = {};
