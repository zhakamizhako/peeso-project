...
class CompanyJobSeeder {
  async run() {
    ...
    await Database.table('companies').insert([
      { user_id: 3, is_overseas: false, name: "ARRIESGADO COLLEGE FOUNDATION, INC", address: "201 Bonifacio St., Tagum City", contact_no: "(084) 216-9807", email: "arriesgadocollege1989@yahoo.com.ph ", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 4, is_overseas: false, name: "MANDAUE FOAM INDUSTRIES INC.", address: "Lanang Executive Homes, KM 7, Davao City", contact_no: "(082) 234-4900", email: "davaomandauefoam@gmail.com", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 5, is_overseas: false, name: "CHRONOPIPE GROUP CORP.", address: "PRK 6B STO NINO CARMEN DAVAO DEL NORTE", contact_no: "09177164830", email: "ellen.nuez@chronopipe.com", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 6, is_overseas: false, name: "FUTURE LIFE CARE", address: "Cor. Sobrecary St., Door 1 and 2 2nd floor, Elizabeth Building, Sison Subd., South Poblacion, Tagum City", contact_no: "(081) 216-2154/ 09658259763", email: "enacyawan82@gmail.com", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 7, is_overseas: false, name: "KENNEMER FOODS INTERNATIONAL", address: "Unit 23&24,2nd floor, CBC Building, Pioneer Avenue,Magugpo South, Tagum City.", contact_no: "0912-957-0488", email: "recruitment@kennemer.ph", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 8, is_overseas: false, name: "TAGUM WATER DISTRICT", address: "National Highway, Tagum City", contact_no: "0912-957-0488", email: "tagumwd.hrmpsb@tagum-water.gov.ph", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 9, is_overseas: false, name: "TAGUM COOPERATIVE", address: "Tagum Cooperative, Dalisay Road, Magugpo West, Tagum City", contact_no: "", email: "", vision: "", mission: "", development_thrusts: "hrdrecruitment@tagumcooperative.coop ", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 10, is_overseas: false, name: "HONDA CARS TAGUM", address: "", contact_no: "09355843293", email: "aestorco@ancgroup.co", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 11, is_overseas: false, name: "PHILAM LIFE TAGUM", address: "", contact_no: "09068011055", email: "claribelpallon@gmail.com", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
      { user_id: 12, is_overseas: true, name: "ANNIEPIE TAGUM", address: "", contact_no: "", email: "rjmvillanueva@gmail.com", vision: "", mission: "", development_thrusts: "", type: "Private", employees_min: 5, employees_max: 20 },
