          ...
          <List>
            ...
            <List.Item>
              ...
              <InputItem
                ...
                type={
                  this.state.visiblePassword ? 'visible-password' : 'password'
                }
                value={this.props.email ? null : this.state.password}
                onChange={(val) =>
                  this.setState((state) => {
                    let {password} = state;
                    password = val;
            ...
            {!this.state.isSubmitting && this.state.error && (
...
export default connect(mapStateToProps, mapActionCreators)(SignupEmail);
