        ...
        return (
            <View style={{ height: '100%' }}>
                ...
                <WingBlank>
                    ...
                    {this.props.auth.loginData && this.props.auth.loginData.profile && this.props.auth.loginData.profile.is_company && (<Text style={{ alignSelf: 'center', justifyContent: 'center', fontSize: 16, fontStyle: 'italic' }}>CompanyName</Text>)}
                    {this.props.auth.loginData && this.props.auth.loginData.profile && !this.props.auth.loginData.profile.is_company && (<Text style={{ alignSelf: 'center', justifyContent: 'center', fontSize: 16, fontStyle: 'italic' }}>Government Employee Freelancer</Text>)}
                    <WhiteSpace size="lg" />
                    <WhiteSpace size="lg" />
                    <WhiteSpace size="lg" />
                    {this.props.auth.loginData && this.props.auth.loginData.profile && this.props.auth.loginData.profile.is_company && (<List>
                        <List.Item onPress={() => this.props.navigation.navigate("")}>Post a Job</List.Item>
