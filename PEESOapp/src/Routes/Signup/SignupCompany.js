    ...
    render() {
        return (
            <ScrollView style={{ height: '100%' }}>
                <WhiteSpace size="lg" />
                <WingBlank>
                    <Text style={{ fontSize: 25 }}>Tell us about you and your company.</Text>
                    <WhiteSpace size={"lg"} />
                    <WhiteSpace size={"lg"} />
                    ...
                    <List>
                        <List.Item>
                            ...
                            <TextAreaItem autoHeight value={this.state.company_name} onChange={(val) => this.setState(state => {
                    ...
                    <Button type="primary" onPress={() => {
                        Modal.alert('Disclaimer', (<ScrollView>
                            <View>
                                ...
                                <Text style={{ textAlign: 'justify' }}>Not the final disclaimer notice and agreement notice either way.</Text>
                            </View>
                        </ScrollView>), [
