    ...
    render() {
        return (
            <View style={{ height: '100%' }}>
                <WhiteSpace size="lg" />
                <WingBlank>
                    <Text style={{ fontSize: 25 }}>What are you creating an account for?</Text>
                    <WhiteSpace size={'lg'} />
                    <Radio></Radio>
                    <List>
                        <Radio.RadioItem name="Applicant" checked={this.state.selectedRadio == 0}
                            onChange={event => {
                        ...
                        <Radio.RadioItem name="Freelance Employer" checked={this.state.selectedRadio == 1} onChange={event => {
                            if (event.target.checked) {
                        ...
                        <Radio.RadioItem name="Company" checked={this.state.selectedRadio == 2} onChange={event => {
                            if (event.target.checked) {
                    ...
                    <WhiteSpace size={"lg"} />
                    <WhiteSpace size={"lg"} />
                    <Button type="primary" disabled={this.state.selectedRadio == null} onPress={() => {
